...
//    @ Override
	 ...
	 * @return
	 */
	private double[] SavGolMethod(double[] OriginSet,double[] SGampleSet,int NumSample,int NumValue,int nl,int nr,int m,int ld)
	{
		long i,j,k;
	...
	public String CheckPositive(int Parameter,String prefix,String Info)
	{
		if(Parameter<1)
		{
			Info=prefix + "必须是正整数";
	...
	public String CheckOddNumber(int Parameter,String prefix,String Info)
	{
		if(Parameter%2==0)
		{
			Info=prefix + "必须是正奇数";
